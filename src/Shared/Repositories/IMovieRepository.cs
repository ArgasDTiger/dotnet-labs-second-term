...
public interface IMovieRepository
{
    ...
    Task<OneOf<None, NotFound>> UpdateMovieAsync(Guid movieId, UpdateMovieRequest movie,
        CancellationToken cancellationToken);

    Task<OneOf<None, NotFound>> DeleteMovieAsync(Guid movieId, CancellationToken cancellationToken);
    Task<OneOf<None, ErrorMessage>> RentMovieAsync(RentMovieRequest request, CancellationToken cancellationToken);
    Task<OneOf<None, ErrorMessage>> ReturnMovieAsync(ReturnMovieRequest request, CancellationToken cancellationToken);
}